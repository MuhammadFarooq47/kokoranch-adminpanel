...
const BannerDetails = ({ setSidebar, sidebar, setView }) => {
    ...
    <div>
      ...
      <div className="bg-black-pad my-5 " style={{ height: "80vh" }}>
        <div className="soi-top">
          <div className="row mb-3">
            ...
            >
              ...
              >
                ...
                <h4 style={{ color: "#14A384", fontWeight: "bold" }}>01</h4>
              </div>
            </div>

            <div className="col-12 col-sm-6 col-md-6 col-lg-6  d-flex justify-content-end align-items-center">
              <button
                onClick={() => {
                  navigate(
                    `/banners/${
                      location.pathname == "/banners/app/details"
                        ? "app"
                        : "web"
                    }/Edit/banner-details`
                  );
          ...
          <div className="row">
            <div className="col-6 col-sm-12 col-md-6 col-lg-6 d-flex justify-content-between align-items-center">
              <h5
                style={{
                  letterSpacing: "1px",
                  textAlign: "end",
        ...
        <div className="soi-main">
          <div className="row ">
            ...
            <div className="col-12 col-sm-8 col-md-8 col-lg-8 mt-3 mx-3 mb-4">
              <p>
                ...
                ut risus lacinia, blandit congue velit.
              </p>
            </div>
