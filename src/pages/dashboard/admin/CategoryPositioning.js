...
const CategoryPositioning = ({ setSidebar, sidebar }) => {
  ...
  const [data, setData] = useState([
    { id: 1, label: "Plants" },
    { id: 2, label: "Plant Nutrients" },
    { id: 3, label: "Plant Media" },
    { id: 4, label: "Plant Containers" },
    { id: 5, label: "Plant Support" },
    { id: 6, label: "Floral Supplies" },
    { id: 7, label: "Pest Management" },
    // "Plant Containers",
    // "Plant Support",
    // "Floral Supplies",
    // "Pest Management",
      ...
      >
        ...
        >
          ...
          >
            ...
            <span
              style={{ color: "#707070", letterSpacing: 1, fontSize: "14px" }}
            >
              If the number of main categories will increase from 11, then more
              categories will be shown here. You can drag any category here from
              left “Main Category” section and can also drag any category from
              here to left “Main Category” section.
            </span>
          </Grid>
        </Grid>
      </div>
